...
import {
  BidiModule,
  Directionality
} from "./chunk-6M7N43SN.js";
import {
  Location
} from "./chunk-LXBPQ4MA.js";
import {
  DOCUMENT,
  isPlatformBrowser
} from "./chunk-7CC7WGU5.js";
import {
...
var Typeahead = class {
  ...
  _setupKeyHandler(typeAheadInterval) {
    this._letterKeyStream.pipe((0, import_operators8.tap)((letter) => this._pressedLetters.push(letter)), (0, import_operators8.debounceTime)(typeAheadInterval), (0, import_operators8.filter)(() => this._pressedLetters.length > 0), (0, import_operators8.map)(() => this._pressedLetters.join("").toLocaleUpperCase())).subscribe((inputString) => {
...
var TreeKeyManager = class {
  ...
  _expandCurrentItem() {
    ...
    if (!this._isCurrentItemExpanded()) {
      ...
      coerceObservable(this._activeItem.getChildren()).pipe((0, import_operators9.take)(1)).subscribe((children) => {
  ...
  _expandAllItemsAtCurrentItemLevel() {
    ...
    itemsToExpand.pipe((0, import_operators9.take)(1)).subscribe((items) => {
...
var MatDialogRef = class {
  ...
  _afterOpened = new import_rxjs15.Subject();
  /** Subject for notifying the user that the dialog has started closing. */
  _beforeClosed = new import_rxjs15.Subject();
  ...
  constructor(_ref, config, _containerInstance) {
    ...
    _containerInstance._animationStateChanged.pipe((0, import_operators11.filter)((event) => event.state === "opened"), (0, import_operators11.take)(1)).subscribe(() => {
      this._afterOpened.next();
      this._afterOpened.complete();
    });
    _containerInstance._animationStateChanged.pipe((0, import_operators11.filter)((event) => event.state === "closed"), (0, import_operators11.take)(1)).subscribe(() => {
    ...
    (0, import_rxjs15.merge)(this.backdropClick(), this.keydownEvents().pipe((0, import_operators11.filter)((event) => event.keyCode === ESCAPE && !this.disableClose && !hasModifierKey(event)))).subscribe((event) => {
      if (!this.disableClose) {
        event.preventDefault();
  ...
  close(dialogResult) {
    ...
    this._containerInstance._animationStateChanged.pipe((0, import_operators11.filter)((event) => event.state === "closing"), (0, import_operators11.take)(1)).subscribe((event) => {
...
var MatDialog = class _MatDialog {
  ...
  _openDialogsAtThisLevel = [];
  _afterAllClosedAtThisLevel = new import_rxjs15.Subject();
  _afterOpenedAtThisLevel = new import_rxjs15.Subject();
   ...
   * Will emit on subscribe if there are no open dialogs to begin with.
   */
  afterAllClosed = (0, import_rxjs15.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators11.startWith)(void 0)));
  constructor() {
